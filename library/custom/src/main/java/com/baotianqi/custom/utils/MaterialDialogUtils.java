...
public class MaterialDialogUtils {
    ...
    public void showThemed(Context context, String
        ...
        new MaterialDialog.Builder(context)
                ...
                .backgroundColorRes(com.baotianqi.custom.R.color.material_blue_grey_800)
                .dividerColorRes(android.R.color.white)
                .btnSelector(com.baotianqi.custom.R.drawable.md_selector, DialogAction.POSITIVE)
...
//        });
    ...
    public static MaterialDialog.Builder showIndeterminateProgressDialog(Context context, String content, boolean horizontal) {
        MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                ...
                .widgetColorRes(com.baotianqi.custom.R.color.colorPrimary)
...
//                .checkBoxPromptRes(R.string.app_name, false, null)
    ...
    public static MaterialDialog.Builder showMultiListDialog(final Context context, String title, List
        ...
        MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                ...
                .positiveText(com.baotianqi.custom.R.string.md_choose_label)
                .autoDismiss(false)
                .neutralText("clear")
