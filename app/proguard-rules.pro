...
-keep public class com.baotianqi.valpromise.R$*{
...
-keep class com.example.http.bean.** { *; }
...
#自定义控件
#-dontwarn com.baotianqi.valpromise.view.**
-keep class com.baotianqi.valpromise.bean.** { *; }
